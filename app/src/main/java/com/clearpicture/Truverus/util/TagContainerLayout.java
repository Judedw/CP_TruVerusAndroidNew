...
import static com.clearpicture.Truverus.util.Utils.dp2px;
import static com.clearpicture.Truverus.util.Utils.sp2px;
...
public class TagContainerLayout extends ViewGroup {
     ...
     */
    private int mBorderColor = Color.parseColor("#636C70");
     ...
     */
    private int mTagBorderColor = Color.parseColor("#636C7000");
    ...
    /**
     * Selected TagView background color(default #bdbdbd)
     */
