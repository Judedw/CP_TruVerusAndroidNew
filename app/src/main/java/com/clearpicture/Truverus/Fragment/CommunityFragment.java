...
//        viewPagerAdapter = new PagerAdapter(getChildFragmentManager())
    ...
    public void setUpFragments() {
        tabAdapter.addFragment(new FeedBackFragment().newInstance(), "Feednback");
        tabAdapter.addFragment(new PromotionsFragment().newInstance(), "Promotions");
        tabAdapter.addFragment(new EventsFragment().newInstance(), "Events");
